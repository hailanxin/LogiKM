...
- `JMX`配置错误：比如是否只允许本机访问 可以命令确认
- ![1971b46243fe1d547063ee55b1505ed](https://user-images.githubusercontent.com/2869938/154403253-bba08437-8199-4537-8725-6f9447361f19.png)
如果端口号(9393)前的是127.0.0.1就需要修改成本机的ip 在cdh中是修改jmx的broker_java_opts.其他见`2、解决方法`。
